...
from cart_routes import manage_cart, checkout, remove_from_cart, update_cart_item
...
app.add_url_rule('/remove_from_cart', view_func=remove_from_cart, methods=['POST'])
app.add_url_rule('/update_cart_item', view_func=update_cart_item, methods=['POST'])
